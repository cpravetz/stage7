...
export class OWDeepModel extends BaseModel {
    constructor() {
        ...
        super({
            name: "openweb/deepseek-r1:7b",
            modelName: "deepseek-r1:7b", // This is the model name that will be sent to the OpenWebUI API
        ...
        console.log('DeepSeekR1 Model initialized with OpenWebUI interface');
    }
}
