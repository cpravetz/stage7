...
export class GPTOSSModel extends BaseModel {
    constructor() {
        ...
        super({
            name: "openweb/ossgpt20",
            modelName: "gpt-oss:20b", // This is the model name that will be sent to the OpenWebUI API
        ...
        console.log('GPTOSSModel initialized with OpenWebUI interface');
    }
}

const aiModel = new GPTOSSModel();
