...
export const legacyAssistantCatalog: AssistantDefinition[] = [
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'reasoning', 'product-management', 'planning'],
  ...
  },
  {
    ...
    capabilities: ['chat', 'planning', 'logistics', 'coordination'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'reasoning', 'legal-analysis', 'document-review'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'reasoning', 'sales', 'crm'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'reasoning', 'teaching', 'education'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o-mini',
    capabilities: ['chat', 'reasoning', 'hr', 'recruitment'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'reasoning', 'coaching', 'leadership'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'creative', 'marketing', 'analytics'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o-mini',
    capabilities: ['chat', 'reasoning', 'support', 'troubleshooting'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'reasoning', 'analytics', 'reporting'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'creative', 'music', 'composition'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'creative', 'writing', 'screenwriting'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'reasoning', 'finance', 'analysis'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'reasoning', 'healthcare', 'wellness'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o-mini',
    capabilities: ['chat', 'reasoning', 'operations', 'restaurant'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o-mini',
    capabilities: ['chat', 'reasoning', 'operations', 'hospitality'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'reasoning', 'sports', 'analytics'],
  ...
  },
  {
    ...
    model: 'anthropic/claude-3.5-sonnet',
    capabilities: ['chat', 'reasoning', 'architecture', 'engineering-leadership'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'reasoning', 'career', 'coaching'],
  ...
  },
  {
    ...
    model: 'openai/gpt-4o',
    capabilities: ['chat', 'reasoning', 'finance', 'investing'],
