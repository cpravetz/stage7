...
export const GlobalErrorCodes = {
  ...
  PLUGIN_REGISTRY_INITIALIZATION_FAILED: 'PR011_PLUGIN_REGISTRY_INITIALIZATION_FAILED',
  PLUGIN_REGISTRY_NOT_AVAILABLE: 'PR012_PLUGIN_REGISTRY_NOT_AVAILABLE',
  CONFIG_MANAGER_INITIALIZATION_FAILED: 'CM000_CONFIG_MANAGER_INITIALIZATION_FAILED',
  ...
  EXTERNAL_PLUGIN_UNHEALTHY: 'CM022_EXTERNAL_PLUGIN_UNHEALTHY',
  EXTERNAL_PLUGIN_DISABLED: 'CM023_EXTERNAL_PLUGIN_DISABLED',
  CAPABILITIES_MANAGER_UNKNOWN_VERB: 'CM024_UNKNOWN_VERB',
