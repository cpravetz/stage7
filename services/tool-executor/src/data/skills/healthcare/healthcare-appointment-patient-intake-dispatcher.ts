...
const intake = createCodeSkill({
  ...
  inputSchema: createSchemaRecord({
    ...
    patientId: SchemaProps.text({ description: 'Patient identifier used when payload is omitted' }),
    ...
    providerId: SchemaProps.text({ description: 'Optional provider identifier for routing' }),
    facilityId: SchemaProps.text({ description: 'Optional facility identifier for routing' }),
