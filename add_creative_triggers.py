...
FILE = Path("/mnt/1tbHD/ckt_web/stage7/services/tool-executor/src/data/skills/creative/index.ts")
SKILLS = {
    "creative_drafting": {
        "user": ["Write a song", "Write lyrics", "Draft a script", "Create a draft"],
        "schedule": ["Daily creative review", "Weekly theme exploration"],
        "event": ["Draft saved", "Theme selected", "Structure chosen", "Revision requested"],
        "data": ["Lyric density below threshold", "Repetition score high", "Mood consistency low"],
    },
    "creative_trend_planning": {
        "user": ["Check trends", "What's trending", "Plan release"],
        "schedule": ["Weekly trend scan", "Monthly release planning"],
        "event": ["Chart data updated", "Trend signal detected", "Release window opened"],
        "data": ["Trend velocity changes", "Audience demand shifts"],
    },
}
